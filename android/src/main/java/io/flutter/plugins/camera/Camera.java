...
class Camera
  ...
  private void prepareMediaRecorder(String outputFilePath) throws IOException {
    ...
    {
      Log.i(TAG,"recordingProfile is null");
       }
  ...
  public void open(String imageFormatGroup) throws CameraAccessException {
    ...
    Integer imageFormat;
    if (supportedImageFormats.get(imageFormatGroup) == null) {
      Log.w(TAG, "The selected imageFormatGroup is not supported by Android. Defaulting to yuv420");
      imageFormat = ImageFormat.YUV_420_888;
    }
    else
      imageFormat = supportedImageFormats.get(imageFormatGroup);
...
*/
  ...
  private void prepareVideoRenderer() {
    ...
    videoRenderer =
        new VideoRenderer(
            mediaRecorder.getSurface(),1280,720,
