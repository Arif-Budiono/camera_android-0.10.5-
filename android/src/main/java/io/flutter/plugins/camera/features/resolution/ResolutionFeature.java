...
public class ResolutionFeature extends CameraFeature<ResolutionPreset> {
  ...
  public ResolutionFeature(
    ...
    Log.i("ResolutionFeature","ResolutionFeature()");
    Log.i("currentSetting",String.valueOf(currentSetting));
    try {
  ...
  public static EncoderProfiles getBestAvailableCamcorderProfileForResolutionPreset(
    ...
    Log.i("ResolutionFeature","getBestAvailableCamcorderProfileForResolutionPreset");
    Log.i("ResolutionPreset",String.valueOf(preset));
  ...
  private void configureResolution(ResolutionPreset resolutionPreset, int cameraId)
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
      ...
      Log.i("ResolutionFeature", "configureResolution()");
      Log.i("resolutionPreset", String.valueOf(resolutionPreset));
      recordingProfile =
      ...
      if (recordingProfile != null) {
        ...
        switch (resolutionPreset) {
          case max:
          case ultraHigh: {
            captureSize = new Size(7680, 4320);
            previewSize = captureSize;
            break;
          }
          case veryHigh: {
            captureSize = new Size(1920, 1080);
            previewSize = captureSize;
            break;
          }
          case high: {
    ...
    if (!captureSizeCalculated) {
      ...
      Log.i("ResolutionFeature","configureResolution()");
      Log.i("configureResolution()","getBestAvailableCamcorderProfileForResolutionPresetLegacy");
